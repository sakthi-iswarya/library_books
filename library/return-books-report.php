...
{
$adminid=$_GET['aid'];
$msg=mysqli_query($con,"delete from movies where aid='$adminid'");
if($msg)
{
...
<html lang="en">
  ...
  <body>
    ...
    <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Returning Report </b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
          	    <h3><i class="fa fa-angle-right"></i> Returning Books Report</h3>
				<div class="row">  
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="update-book.php?sid=<?php echo $row['rid'];?>"> 
