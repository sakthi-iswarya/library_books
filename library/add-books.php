...
if(isset($_POST['Submit']))
{
    ...
    $book_issue_name=$_POST['book_issue_name'];
    $book_issue_date=$_POST['book_issue_date'];

    $msg=mysqli_query($con,"insert into add_books(book_name,book_issue_name,book_issue_date) 
          values('$book_name','$book_issue_name','$book_issue_date')");
  ...
  <body>
    <section id="container" >
        <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Add Books</b></a>
                    ...
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="book_issue_name" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Book Issue Date</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="book_issue_date" value="" >
                                </div>
                            </div>

                            <div style="margin-left:100px; padding-bottom:20px;" >
                                <input type="submit" name="Submit" value="Add Book" class="btn btn-theme" style="color:white;
